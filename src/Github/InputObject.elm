...
buildCheckRunFilter fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { checkType = Absent, appId = Absent, checkName = Absent, status = Absent }
    in
    { checkType = optionals____.checkType, appId = optionals____.appId, checkName = optionals____.checkName, status = optionals____.status }
...
encodeCheckRunFilter input____ =
    Encode.maybeObject
        [ ( "checkType", Encode.enum Github.Enum.CheckRunType.toString |> Encode.optional input____.checkType ), ( "appId", Encode.int |> Encode.optional input____.appId ), ( "checkName", Encode.string |> Encode.optional input____.checkName ), ( "status", Encode.enum Github.Enum.CheckStatusState.toString |> Encode.optional input____.status ) ]
...
buildCreateBranchProtectionRuleInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { requiresApprovingReviews = Absent, requiredApprovingReviewCount = Absent, requiresCommitSignatures = Absent, requiresLinearHistory = Absent, allowsForcePushes = Absent, allowsDeletions = Absent, isAdminEnforced = Absent, requiresStatusChecks = Absent, requiresStrictStatusChecks = Absent, requiresCodeOwnerReviews = Absent, dismissesStaleReviews = Absent, restrictsReviewDismissals = Absent, reviewDismissalActorIds = Absent, restrictsPushes = Absent, pushActorIds = Absent, requiredStatusCheckContexts = Absent, requiresConversationResolution = Absent, clientMutationId = Absent }
    in
    { repositoryId = required____.repositoryId, pattern = required____.pattern, requiresApprovingReviews = optionals____.requiresApprovingReviews, requiredApprovingReviewCount = optionals____.requiredApprovingReviewCount, requiresCommitSignatures = optionals____.requiresCommitSignatures, requiresLinearHistory = optionals____.requiresLinearHistory, allowsForcePushes = optionals____.allowsForcePushes, allowsDeletions = optionals____.allowsDeletions, isAdminEnforced = optionals____.isAdminEnforced, requiresStatusChecks = optionals____.requiresStatusChecks, requiresStrictStatusChecks = optionals____.requiresStrictStatusChecks, requiresCodeOwnerReviews = optionals____.requiresCodeOwnerReviews, dismissesStaleReviews = optionals____.dismissesStaleReviews, restrictsReviewDismissals = optionals____.restrictsReviewDismissals, reviewDismissalActorIds = optionals____.reviewDismissalActorIds, restrictsPushes = optionals____.restrictsPushes, pushActorIds = optionals____.pushActorIds, requiredStatusCheckContexts = optionals____.requiredStatusCheckContexts, requiresConversationResolution = optionals____.requiresConversationResolution, clientMutationId = optionals____.clientMutationId }
...
buildIssueFilters fillOptionals____ =
    ...
    in
    { assignee = optionals____.assignee, createdBy = optionals____.createdBy, labels = optionals____.labels, mentioned = optionals____.mentioned, milestone = optionals____.milestone, since = optionals____.since, states = optionals____.states, viewerSubscribed = optionals____.viewerSubscribed }
...
encodeIssueFilters input____ =
    Encode.maybeObject
        [ ( "assignee", Encode.string |> Encode.optional input____.assignee ), ( "createdBy", Encode.string |> Encode.optional input____.createdBy ), ( "labels", (Encode.string |> Encode.list) |> Encode.optional input____.labels ), ( "mentioned", Encode.string |> Encode.optional input____.mentioned ), ( "milestone", Encode.string |> Encode.optional input____.milestone ), ( "since", (Github.ScalarCodecs.codecs |> Github.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input____.since ), ( "states", (Encode.enum Github.Enum.IssueState.toString |> Encode.list) |> Encode.optional input____.states ), ( "viewerSubscribed", Encode.bool |> Encode.optional input____.viewerSubscribed ) ]
    ...
    let
        optionals____ =
            fillOptionals____
                { clientMutationId = Absent }
    in
    { issueId = required____.issueId, repositoryId = required____.repositoryId, clientMutationId = optionals____.clientMutationId }
...
encodeTransferIssueInput input____ =
    Encode.maybeObject
        [ ( "issueId", (Github.ScalarCodecs.codecs |> Github.Scalar.unwrapEncoder .codecId) input____.issueId |> Just ), ( "repositoryId", (Github.ScalarCodecs.codecs |> Github.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
...
buildUpdateBranchProtectionRuleInput required____ fillOptionals____ =
    let
        optionals____ =
            fillOptionals____
                { pattern = Absent, requiresApprovingReviews = Absent, requiredApprovingReviewCount = Absent, requiresCommitSignatures = Absent, requiresLinearHistory = Absent, allowsForcePushes = Absent, allowsDeletions = Absent, isAdminEnforced = Absent, requiresStatusChecks = Absent, requiresStrictStatusChecks = Absent, requiresCodeOwnerReviews = Absent, dismissesStaleReviews = Absent, restrictsReviewDismissals = Absent, reviewDismissalActorIds = Absent, restrictsPushes = Absent, pushActorIds = Absent, requiredStatusCheckContexts = Absent, requiresConversationResolution = Absent, clientMutationId = Absent }
    in
...
buildUpdateRepositoryInput required____ fillOptionals____ =
    ...
    in
    { repositoryId = required____.repositoryId, name = optionals____.name, description = optionals____.description, template = optionals____.template, homepageUrl = optionals____.homepageUrl, hasWikiEnabled = optionals____.hasWikiEnabled, hasIssuesEnabled = optionals____.hasIssuesEnabled, hasProjectsEnabled = optionals____.hasProjectsEnabled, clientMutationId = optionals____.clientMutationId }
...
encodeUpdateRepositoryInput input____ =
    Encode.maybeObject
        [ ( "repositoryId", (Github.ScalarCodecs.codecs |> Github.Scalar.unwrapEncoder .codecId) input____.repositoryId |> Just ), ( "name", Encode.string |> Encode.optional input____.name ), ( "description", Encode.string |> Encode.optional input____.description ), ( "template", Encode.bool |> Encode.optional input____.template ), ( "homepageUrl", (Github.ScalarCodecs.codecs |> Github.Scalar.unwrapEncoder .codecUri) |> Encode.optional input____.homepageUrl ), ( "hasWikiEnabled", Encode.bool |> Encode.optional input____.hasWikiEnabled ), ( "hasIssuesEnabled", Encode.bool |> Encode.optional input____.hasIssuesEnabled ), ( "hasProjectsEnabled", Encode.bool |> Encode.optional input____.hasProjectsEnabled ), ( "clientMutationId", Encode.string |> Encode.optional input____.clientMutationId ) ]
