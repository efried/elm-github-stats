...
{-| Events involving this sponsorable, such as new sponsorships.
  ...
  - first - Returns the first _n_ elements from the list.
  - last - Returns the last _n_ elements from the list.
  - period - Filter activities returned to only those that occurred in a given time range.
...
sponsorsActivities fillInOptionals____ object____ =
    let
        filledInOptionals____ =
            fillInOptionals____ { after = Absent, before = Absent, first = Absent, last = Absent, period = Absent, orderBy = Absent }
