...
members fillInOptionals____ object____ =
    let
        filledInOptionals____ =
            fillInOptionals____ { organizationLogins = Absent, query = Absent, orderBy = Absent, role = Absent, deployment = Absent, after = Absent, before = Absent, first = Absent, last = Absent }

        optionalArgs____ =
            [ Argument.optional "organizationLogins" filledInOptionals____.organizationLogins (Encode.string |> Encode.list), Argument.optional "query" filledInOptionals____.query Encode.string, Argument.optional "orderBy" filledInOptionals____.orderBy Github.InputObject.encodeEnterpriseMemberOrder, Argument.optional "role" filledInOptionals____.role (Encode.enum Github.Enum.EnterpriseUserAccountMembershipRole.toString), Argument.optional "deployment" filledInOptionals____.deployment (Encode.enum Github.Enum.EnterpriseUserDeployment.toString), Argument.optional "after" filledInOptionals____.after Encode.string, Argument.optional "before" filledInOptionals____.before Encode.string, Argument.optional "first" filledInOptionals____.first Encode.int, Argument.optional "last" filledInOptionals____.last Encode.int ]
                |> List.filterMap Basics.identity
    in
